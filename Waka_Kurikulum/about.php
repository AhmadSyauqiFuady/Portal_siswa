...
<!-- besok lanjut di siswa upload bukti tf aja , sama pikirkan gimana baiknya di jadwal apakah langsung 

ditampilkan apa di select per user? sama kalau sempat nyicil kolom nilai.-->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li style='background-color:red' class="logout"><a href="../logout.php">keluar<i class="fa fa-sign-out"></i></a></li>
          </ul>
        </section>
        <!-- /.sidebar -->
      </aside>
