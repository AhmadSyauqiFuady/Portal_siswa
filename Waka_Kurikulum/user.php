        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
					...
					<li class="active"><a href="pengguna.php"><i class="fa fa-user-circle-o"></i><span>User</span></a></li>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
				<a href="#"><button class="btn btn-success" type="button" data-target="#ModalAddDosen" data-toggle="modal"><i class="fa fa-plus"></i> Add</button></a>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Tambah guru sebagai pengguna</h4>
						<br />
										...
										<select name="User_Dosen" class="form-control">
											<?php
												...
												while($dosen = mysqli_fetch_array($querydosen)){
													if($dosen["kode_guru"] != $_SESSION["Username"]){
														echo "<option value='$dosen[kode_guru]'>$dosen[Nama_Dosen]</option>";
													}
												}
											?>
										</select>
