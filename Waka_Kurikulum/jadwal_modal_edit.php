				...
				<form action="jadwal_edit.php" name="modal_popup" enctype="multipart/form-data" method="post">
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input name="id" type="text" class="form-control" placeholder="Masukan id jadwal" readonly value="<?php echo $jadwal['Id_Jadwal'] ?>" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input name="jam" type="text" class="form-control" placeholder="masukan jam belajar" value="<?php echo $jadwal['jam'] ?>" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input name="berkas" type="text" class="form-control" placeholder="link gmeet" value="<?php echo $jadwal["link_gmeet"] ?>" required />
