                        ...
                        <tr>
                          ...
                          <td class="align-middle text-center text-sm">
                            ...
                            <span class="badge badge-sm bg-gradient-danger">
                              <a class="text-white" href="#" onclick="confirm_delete(`kelas_delete.php?id_kelas=<?= $pelajaran['id_pelajaran'] ?>`)">Delete</a>
                            </span>
                          </td>
                        </tr>
                      <?php endwhile; ?>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="kode_pelajaran" placeholder="Masukkan Kode Kelas" id="kode" required>
              </div>
              <div class="form-group">
                <label for="nama" class="form-control-label">Nama Pelajaran</label>
                <input class="form-control" type="text" name="nama_pelajaran" placeholder="Masukkan Nama Kelas" id="nama" required>
              </div>
              <div class="form-group">
